...
import ProductCard from '../ProductCard.jsx'; // Importa o card de produto
import Skeleton from '../Skeleton.jsx'; // Importa o skeleton separado
import styles from '../style/App.module.css'; // Reutiliza o CSS Module do App para layout e grid
    ...
    <section className={styles.grid} aria-label="Lista de produtos"> {/* Grid com rótulo acessível */}
      {loading // Se estiver carregando
        ? Array.from({ length: 6 }).map((_, i) => ( // Cria 6 skeletons
            <Skeleton key={'skeleton-' + i} /> // Usa o componente Skeleton
